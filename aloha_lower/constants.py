...
LEADER_GRIPPER_CLOSE_THRESH = -0.33

# Left finger position limits (qpos[7]), right_finger = -1 * left_finger
LEADER_GRIPPER_POSITION_OPEN = 0.02417
LEADER_GRIPPER_POSITION_CLOSE = 0.01244

FOLLOWER_GRIPPER_POSITION_OPEN = 0.05800
FOLLOWER_GRIPPER_POSITION_CLOSE = 0.01844

# Gripper joint limits (qpos[6])
LEADER_GRIPPER_JOINT_OPEN = 0.3083
LEADER_GRIPPER_JOINT_CLOSE = -0.31753402948379517

FOLLOWER_GRIPPER_JOINT_OPEN = 1.4910
FOLLOWER_GRIPPER_JOINT_CLOSE = -0.6213

MUJOCO_GRIPPER_JOINT_OPEN = 0.57
MUJOCO_GRIPPER_JOINT_CLOSE = -0.25
...
MUJOCO_GRIPPER_JOINT_UNNORMALIZE_FN = lambda x: x * (MUJOCO_GRIPPER_JOINT_OPEN - MUJOCO_GRIPPER_JOINT_CLOSE) + MUJOCO_GRIPPER_JOINT_CLOSE
LEADER2MUJOCO_GRIPPER_JOINT_FN = lambda x: MUJOCO_GRIPPER_JOINT_UNNORMALIZE_FN(LEADER_GRIPPER_JOINT_NORMALIZE_FN(x))
