...
RIGHT_ROBOT_TRANSFORMATION_MATRIX = [[math.cos(math.radians(90)), -math.sin(math.radians(90)), 0,0],
...
LEFT_ROBOT_TRANSFORMATION_MATRIX = [[math.cos(math.radians(-90)), -math.sin(math.radians(-90)),0, 0],
                                     [math.sin(math.radians(-90)), math.cos(math.radians(-90)), 0,0.45                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ],
                                     [0, 0,1, -0.3],
                                     [0, 0,0,1]]
